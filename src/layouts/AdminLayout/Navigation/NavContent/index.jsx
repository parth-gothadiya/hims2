...
export default function NavContent({ navigation, activeNav }) {
  ...
  const mHeader = (
    <div 
      className="m-header" 
      style={{ 
        backgroundColor: "#3d4b54", 
        padding: "10px", 
        borderRight: "1px solid white", // Reduce white line visibility
        borderBottom: "1px solid white" ,// Reduce white line visibility
      }}
    >
 <Link to="/dashboard/sales" className="b-brand" style={{ textDecoration: "none", display: "block"}}>
  <h1 
    style={{ 
      color: "white", 
      fontWeight: "bold", 
