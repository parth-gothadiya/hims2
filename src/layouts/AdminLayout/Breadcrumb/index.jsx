...
export default function Breadcrumb() {
  ...
  if (item && item.type === 'item') {
    ...
    if (item.breadcrumbs !== false) {
      breadcrumbContent = (
        <div className="page-header" style={{ backgroundColor: "#3d4b54", padding: "10px" }}>
            ...
            <Row className="align-items-center">
              <Col md={8}>
                ...
                <ListGroup as="ul" bsPrefix=" " className="breadcrumb">
                  ...
                  {mainContent && React.cloneElement(mainContent, { style: { color: "white"  } })}
                  {itemContent && React.cloneElement(itemContent, { style: { color: "white" } })}
                </ListGroup>
              </Col>
              {main.title === 'Layouts' && (
